<?php
      ...
      function request($course_title, $start_from, $end_at, $day) {
            ...
            echo $db->query($drop_prev_conflict_view);
            echo $db->query($create_conflict_view);
            ...
            echo $db->query($drop_course_id);
            echo $db->query($create_course_id_view);
            ...
            echo $db->query($drop_pseudosuggested);
            echo $db->query($create_pseudosuggedted_view);
            ...
            echo $db->query($drop_enrollement_conflict);
            echo $db->query($create_enrollement_conflict_view);
