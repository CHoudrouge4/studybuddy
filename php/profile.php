<?php
  ...
  if(isset($_SESSION['email'])) {
    ...
    $usr     = new user();
    $row     = $usr->get_user_info($email); //$db->SELECT($stmt);
  ...
  <!--       <script src="Script/datamanip.js"></script>-->
    ...
    <body onload ="load_user()">
        <?php
           ...
           if($_POST && isset($_POST['add_course_botton'], $_POST['course_name'])) {
                ...
                if(!$course) {
                  ...
                  $errorMsg = "please the to time fields";
                    ...
                    $cs->add($course, $from, $to, $days);
                    $cs->ennrollement($id, $course, $from, $to, $days);
